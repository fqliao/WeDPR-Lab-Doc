...
本章介绍搭建隐私计算网络的必要安装和配置。通过在单机上部署一个2机构的WeDPR隐私计算网络，帮助用户掌握WeDPR隐私计算平台的部署流程，请参考[系统和硬件要求](./hardware_requirements.md)使用支持的硬件和平台。
...
# 打开配置模板config.toml，配置合约工厂地址为上面部署的合约地址0x45c4ac4bf51d82d820b2ed904611e3fc37b6a737(请您根据实际使用情况配置)
